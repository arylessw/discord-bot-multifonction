module.exports = {
  name: 'mute',
  description: 'Rend muet un membre',
  category: 'Gestion',
  async execute(message, args, client) {
    ...
    if (member.roles.highest.position >= message.member.roles.highest.position) {
      return message.reply('Vous ne pouvez pas rendre muet quelqu\'un qui a un rôle supérieur ou égal au vôtre.');
    }

    if (member.isCommunicationDisabled()) {
      return message.reply('Ce membre est déjà muet.');
    }
